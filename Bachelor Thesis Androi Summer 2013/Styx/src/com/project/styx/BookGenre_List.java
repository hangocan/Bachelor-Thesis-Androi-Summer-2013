...
public class BookGenre_List extends ListActivity {
	
	private static final int intDefaultSortOption = -1;
	private static int intSortOption = BookGenre_List.intDefaultSortOption;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			errExcpError.addToLogFile(error, "BookGenre_List.onCreate", "");
			errExcpError = null;
	...
	private void fillData() {
		...
		try {
			...
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
					BookGenre_List.this);
			errExcpError.addToLogFile(error, "BookGenre_List.fillData", "");
			errExcpError = null;
			...
			int itemId = item.getItemId();
			{
				if (itemId == R.id.sorting_options) {
						...
						if (this.dbAppDbObj != null) {
							...
							if (dbOpenResult) {
								cursorTableQuery = this.dbAppDbObj
										.exportTableQuery(MyAppDbAdapter.MY_BOOK_GENRE_DB_TABLE,
								...
								objDBTableExport
										.exportAsCSVFile(	cursorTableQuery,
																MyAppDbAdapter.MY_BOOK_GENRE_DB_TABLE);
								BookGenre_List.objDisplayAlertClass = new MyDisplayAlertClass(
										BookGenre_List.this,
					...
					// end try
						...
						errExcpError
								.addToLogFile(	error,
													"BookGenre_List.onMenuItemSelected",
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		try {
			if (this.mEntryCursor != null) {
				...
				Intent i = new Intent(this, AddEditBookGenre.class);
			...
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(this);
			errExcpError
					.addToLogFile(error, "BookGenre_List.onListItemClick", "");
			errExcpError = null;
		}// end try/catch
	}// end onListItemClick
	...
	protected void myAppCleanup() {
		try {
			if (BookGenre_List.objDisplayAlertClass != null) {
				BookGenre_List.objDisplayAlertClass.cleanUpClassVars();
				BookGenre_List.objDisplayAlertClass = null;
			}
			if (this.mEntryCursor != null) {
			...
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
					BookGenre_List.this);
			errExcpError.addToLogFile(	error, "BookGenre_List.myAppCleanup",
												"no prompt");
			errExcpError = null;
		}// end try/catch (Exception error)
	}// end myAppCleanup
	...
	protected static void getSortOption(Context ctxContext) {
		try {
			GetSortOptions objGetSortOptions = new GetSortOptions(ctxContext,
					"BookGenre_List", "BookSortOpt");
			BookGenre_List.intSortOption = objGetSortOptions.getIntSortOption("");
			...
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
					ctxContext);
			errExcpError
					.addToLogFile(	error, "BookGenre_List.getSortOption",
										"An Error Occured, Sort Option set to default, sorted by rowID");
			errExcpError = null;
			BookGenre_List.intSortOption = BookGenre_List.intDefaultSortOption;
		}// end try/catch (Exception error)
	}// end getSortOption
	...
	protected void onResume() {
		...
		try {
			if (this.blSaveNew == true) {
				...
				Intent intentInsrt = new Intent(BookGenre_List.this,
						AddEditBookGenre.class);
			...
			BookGenre_List.getSortOption(BookGenre_List.this);
			this.fillData();
			this.registerForContextMenu(this.getListView());
		} catch (Exception error) {
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
					BookGenre_List.this);
			errExcpError.addToLogFile(error, "BookGenre_List.resumeData", "");
			errExcpError = null;
		}// end try/catch (Exception error)
	}// end onResume
		...
		try {
			...
			switch (id) {
				case DELETE_CONFIRMATION_MESSAGE:
					new AlertDialog.Builder(BookGenre_List.this)
														...
														new DialogInterface.OnClickListener() {
															...
															public void onClick(	DialogInterface dialog,
																...
																AdapterContextMenuInfo info = (AdapterContextMenuInfo) item
																		.getMenuInfo();
																try {
																	boolean dbOpenResult = BookGenre_List.this.dbAppDbObj
																			.openDbAdapter();
																	if (dbOpenResult) {
																		boolean blIsSuccessful = BookGenre_List.this.dbAppDbObj
																				.deleteBookEntry(info.id);
																		boolean dbCloseResult = BookGenre_List.this.dbAppDbObj
																				.closeDbAdapter();
																		if (!dbCloseResult) throw new Exception(
																				"The database was not successfully closed.");
																	...
																	errExcpError
																			.addToLogFile(	error,
																								"BookGenre_List.displayConfirmRequest.deleteBookEntry",
																								"");
																	errExcpError = null;
														...
														new DialogInterface.OnClickListener() {
															...
															public void onClick(	DialogInterface dialog,
																...
																try {
																	...
																	errExcpError
																			.addToLogFile(	error,
																								"BookGenre_List.displayConfirmRequest.deleteBookEntries",
																								"");
																	errExcpError = null;
																}// end try/catch (Exception
																	// error)
			...
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
					BookGenre_List.this);
			errExcpError
					.addToLogFile(error, "BookGenre_List.displayConfirmRequest", "");
			errExcpError = null;
		}// end try/catch (Exception error)
	...
	public void onSaveInstanceState(Bundle savedInstanceState) {
		...
		try {
			...
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
					BookGenre_List.this);
			errExcpError.addToLogFile(	error,
												"BookGenre_List.onSaveInstanceState",
												"no prompt");
			errExcpError = null;
		}// end try/catch (Exception error)
	...
	public void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		try {
			...
			MyErrorLog<Exception> errExcpError = new MyErrorLog<Exception>(
					BookGenre_List.this);
			errExcpError.addToLogFile(	error,
												"BookGenre_List.onRestoreInstanceState",
												"no prompt");
			errExcpError = null;
		}// end try/catch (Exception error)
